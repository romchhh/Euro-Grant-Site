...
const steps = [
  {
    ...
    desc: 'Ви заповнюєте форму та оплачуєте €10. Ми пов\'язуємося з вами та проводимо детальний аналіз вашого бізнесу та цілей.',
    duration: '1-2 дні',
  },
  {
    num: '02',
    title: 'Оцінка можливостей',
    desc: 'Наша команда аналізує підходящі програми грантів та інвестицій, формує список оптимальних варіантів для вашого випадку.',
    duration: '3-5 днів',
  },
  {
    num: '03',
